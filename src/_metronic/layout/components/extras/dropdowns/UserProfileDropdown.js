...
// import { actionTypes as actiontypesHomes } from '../../../../../redux/home/home_select_slider';
...
{/* 
        ...
        <div className="navi navi-spacer-x-0 pt-5">
          ...
          {/* <Link to="/help" className="navi-item px-8 cursor-pointer">
            <div className="navi-link">
              <div className="navi-icon mr-2">
                <i className="flaticon2-information icon-md text-success font-weight-bold" />
              </div>
              <div className="navi-text">
                <div className="font-weight-bold cursor-pointer" >
                  راهنمای ثبت نام
