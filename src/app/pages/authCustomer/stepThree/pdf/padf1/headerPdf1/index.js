        ...
        <View style={stylePdf.position}>
          ...
          <View style={stylePdf.titleParent}>
            <Text style={stylePdf.titleText}>
              فرم اقرارنامه و بیانیه پذیرش ریسک
            </Text>
            <Text style={stylePdf.titleText}>معاملات سهام و حق تقدم خرید</Text>
            <Text style={stylePdf.titleText}>
              سهام در بازار پایه فرابورس ایران
            </Text>
          </View>
        </View>
